...
Do you want to continue the installation?</source>
        <translation>Εκτελείτε 32bit λειτουργικό σύστημα σε λειτουργία 64bit UEFI. Το σύστημα δε θα είναι σε θέση να εκκινήσει εκτός εάν επιλέξετε Legacy Boot ή κάτι παρόμοια κατά την επανεκκίνηση.
...
Το %1 στηρίζεται από ανθρώπους σαν κι&apos; εσάς. Κάποιο βοηθούν κάποιους άλλους στο forum υποστήριξης- %2, ή μεταφράζουν αρχεία βοήθειας σε διάφορες γλώσσες, ή κάνουν υποδείξεις, γράφουν τεκμηρίωση, ή βοηθούν δοκιμάζοντας νέο λογισμικό.&lt;/p&gt;</translation>
    </message>
    <message>
...
Απολαύστε τη χρήση του %1.</translation>
    ...
    <message>
        ...
        <translation type="vanished">&lt;p&gt;&lt;b&gt;Υποστηρίξτε το %1
...
<context>
    ...
    <message>
        ...
        <translation>Δεν ήταν δυνατό το ξεκλείδωμα της συσκευής. Πιθανός λανθασμένος κωδικός πρόσβασης.</translation>
    </message>
    <message>
